...
public static class GuiWindowTexturePreview {
	...
	private static Vector2 _textureWindowSize = new(500, 500);
	private static Vector2 _textureWindowPosition = new(250, 250);

	public static bool IsMouseHovered => UvPreviewBounds.Contains(AppInput.ThisMousePosition);

	public static Rectangle UvPreviewBounds => new(
