...
public class TransformWidgetAxis {
	...
	public readonly List<Vector3> SelectionStartPositions = new();
	...
	private readonly List<Vector3> _planeVertices = new();
	...
	private List<Vector3> GetAxisArrowDefinition() {
		return new List<Vector3> {
			...
			new(-DistanceFromCenter, ArrowWidth, ArrowWidth),
			new(-DistanceFromCenter, -ArrowWidth, ArrowWidth),
			new(-DistanceFromCenter - ArrowLength, -ArrowWidth * 2, ArrowWidth * 2),
			new(-DistanceFromCenter - ArrowLength, ArrowWidth * 2, ArrowWidth * 2),
			new(-DistanceFromCenter - ArrowLength, ArrowWidth * 2, -ArrowWidth * 2),
			new(-DistanceFromCenter - ArrowLength, ArrowWidth * 2, -ArrowWidth * 2),
			new(-DistanceFromCenter - ArrowLength, -ArrowWidth * 2, -ArrowWidth * 2),
			new(-DistanceFromCenter - ArrowLength, -ArrowWidth * 2, ArrowWidth * 2),
			new(-DistanceFromCenter - ArrowLength, ArrowWidth * 2, ArrowWidth * 2),
			new(-DistanceFromCenter - ArrowLength - ArrowPointLength, 0, 0),
			new(-DistanceFromCenter - ArrowLength, ArrowWidth * 2, -ArrowWidth * 2),
			new(-DistanceFromCenter - ArrowLength, ArrowWidth * 2, -ArrowWidth * 2),
			new(-DistanceFromCenter - ArrowLength - ArrowPointLength, 0, 0),
			new(-DistanceFromCenter - ArrowLength, -ArrowWidth * 2, -ArrowWidth * 2),
