...
public class VertexIndicator {
	...
	private VertexPositionColorTexture[] _vertexIndicatorVertices = System.Array.Empty<VertexPositionColorTexture>();
	private VertexPositionColorTexture[] _normalIndicatorVertices = System.Array.Empty<VertexPositionColorTexture>();
	private readonly DepthStencilState _depthBufferState;

	readonly List<Vector3> _vertexIndicatorDefinition = new() {
	...
	private readonly List<Vector3> _normalIndicatorDefinition = new() {
