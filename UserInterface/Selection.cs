...
public static class Selection {
	public static readonly List<Polygon> SelectedPolygons = new();
	public static List<Polygon> HoveredPolygons = new();
	...
	public static readonly List<TerrainTile> SelectedTerrainTiles = new();
	public static List<TerrainTile> HoveredTerrainTiles = new();
	...
	public static void SelectAllPolygons() {
		...
		Dictionary<PolygonType, List<Polygon>> allPolygons = CurrentMapState.StateData.PolygonCollection[GuiPanelMeshSelector.SelectedMesh];
	...
	public static void GrowPolygonSelection() {
		...
		List<Polygon> polygonsToAddToSelection = new();
	...
	public static void GrowTerrainSelection() {
		...
		List<TerrainTile> tilesToAdd = new();
	...
	private static void CollectHoveredTerrainTiles() {
		List<List<TerrainTile>> allTiles = new();
