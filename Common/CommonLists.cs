...
public static class CommonLists {
	public static readonly List<MeshType> MeshTypes = new() {
	...
	public static readonly List<PolygonType> PolygonTypes = new() {
	...
	public static readonly Dictionary<int, TerrainSurfaceType> TerrainSurfaceTypes = new() {
	...
	public static readonly Dictionary<int, TerrainSlopeType> TerrainSlopeTypes = new() {
