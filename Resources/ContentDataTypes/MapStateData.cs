...
public class MapStateData {
	...
	public bool UsesEndOfTerrainPadding {
		get {
			bool? x = _primaryMeshSource?.UsesEndOfTerrainPadding;
			return x != null && x.Value;
		}
		set => _primaryMeshSource.UsesEndOfTerrainPadding = value;
	}
	...
	public List<Polygon> PolygonCollectionBucket {
		get {
			List<Polygon> polygonCollectionBucket = new();
	...
	public bool HasAnimatedMesh2 => _animatedMesh2Source is { HasAnimatedMesh2: true };
	public bool HasAnimatedMesh3 => _animatedMesh3Source is { HasAnimatedMesh3: true };
	public bool HasAnimatedMesh4 => _animatedMesh4Source is { HasAnimatedMesh4: true };
	public bool HasAnimatedMesh5 => _animatedMesh5Source is { HasAnimatedMesh5: true };
	public bool HasAnimatedMesh6 => _animatedMesh6Source is { HasAnimatedMesh6: true };
	public bool HasAnimatedMesh7 => _animatedMesh7Source is { HasAnimatedMesh7: true };
	public bool HasAnimatedMesh8 => _animatedMesh8Source is { HasAnimatedMesh8: true };
