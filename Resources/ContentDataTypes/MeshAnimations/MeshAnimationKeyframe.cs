...
public class MeshAnimationKeyframe {
	...
	public readonly List<double> Position = new();
	public readonly List<double> Rotation = new();
	public readonly List<double> Scale = new();
	public readonly List<MeshAnimationTweenType> PositionTweenTypes = new();
	public readonly List<MeshAnimationTweenType> RotationTweenTypes = new();
	public readonly List<MeshAnimationTweenType> ScaleTweenTypes = new();
	public readonly List<double> PositionStartPercents = new();
	public readonly List<double> RotationStartPercents = new();
	public readonly List<double> ScaleStartPercents = new();
	public readonly List<double> PositionEndPercents = new();
	public readonly List<double> RotationEndPercents = new();
	public readonly List<double> ScaleEndPercents = new();
