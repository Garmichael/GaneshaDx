...
public class MeshAnimationSet {
	public readonly List<byte> KeyframesHeader = new();
	public readonly List<MeshAnimationKeyframe> Keyframes = new();

	public readonly List<byte> MeshInstructionSetsHeader = new();
	public readonly List<AnimatedMeshInstructionSet> MeshInstructionSets = new();

	public readonly List<byte> MeshPropertiesHeader = new();
	public readonly List<AnimatedMeshProperties> MeshProperties = new();
	...
	public MeshAnimationSet(List<byte> rawData) {
		...
		for (int instructionIndex = 0; instructionIndex < totalMeshInstructionSets; instructionIndex++) {
			List<byte> meshInstructionProperties = new();
