...
public static class SceneRenderer {
	private static readonly List<DirectionalLightIndicator> LightIndicators = new();
	public static readonly List<Palette> AnimationAdjustedPalettes = new();
