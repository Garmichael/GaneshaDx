...
public static class MeshAnimationController {
	...
	private static readonly List<MeshType> AnimatedMeshTypes = new() {
	...
	public static readonly Dictionary<MeshType, MeshAnimationRoutine> Animations = new() {
	...
	private static readonly Dictionary<MeshType, AnimatedMeshProperties> MeshProperties = new() {
		{ MeshType.AnimatedMesh1, null },
		{ MeshType.AnimatedMesh2, null },
		{ MeshType.AnimatedMesh3, null },
		{ MeshType.AnimatedMesh4, null },
